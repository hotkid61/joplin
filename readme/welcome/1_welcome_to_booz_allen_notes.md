...
Markdown is a lightweight markup language with plain text formatting syntax. Booz Allen Notes supports a [Github-flavoured Markdown syntax](https://notes.boozallen.com/help/apps/markdown) with a few variations and additions.
...
This is a [link](https://notes.boozallen.com) and, finally, below is a horizontal rule:

* * *

A lot more is possible including adding code samples, math formulae or checkbox lists - see the [Markdown documentation](https://notes.boozallen.com/help/apps/markdown) for more information.

## Organising your notes

### With notebooks

Notes in Booz Allen Notes are organised into a tree of notebooks and sub-notebooks.
